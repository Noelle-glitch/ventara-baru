...
export const SETTINGS_STEPS: GuideStep[] = [
  {
    ...
    description:
      "Di sini kamu bisa mengatur profil akun dan konfigurasi cache sistem untuk performa optimal.",
  },
  {
    id: 1,
    icon: "👤",
  ...
  },
  {
    id: 2,
    icon: "💾",
    title: "Cache Tersimpan",
    description:
      "Menampilkan total ukuran cache model dan metrics yang tersimpan di sistem saat ini.",
    target: "cache-size",
    position: "bottom",
  },
  {
    ...
    title: "Cache Model",
    description:
      "Aktifkan toggle ini agar model yang sudah dilatih tersimpan — sehingga tidak perlu retrain ulang setiap kali generate.",
    target: "toggle-model-cache",
    position: "bottom",
  },
  {
    id: 4,
    ...
    title: "Cache Metrics",
    description:
      "Aktifkan toggle ini untuk menyimpan hasil perhitungan MAE, RMSE, dan MAPE agar proses berikutnya lebih cepat.",
    target: "toggle-metrics-cache",
    position: "top",
  },
];
