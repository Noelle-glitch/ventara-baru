...
const FORECASTING_STORAGE_KEY = "ventara_guide_forecasting_done";
...
export default function ForecastingPage() {
  ...
  const [username, setUsername] = useState<string | null>(null); // ← tambah buat user pertama kali muncul userguide
  ...
  } = useGuide({ steps: FORECASTING_STEPS, storageKey: guideStorageKey });
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-8">
          <div className="max-w-5xl mx-auto">
            ...
            {/* STATUS BOX ada Userguide wrapper */}
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              ...
              {/* PILIH MODEL ada userguide wrpper */}
