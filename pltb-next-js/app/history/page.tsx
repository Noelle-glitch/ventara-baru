...
export default function HistorisPage() {
  ...
  } = useGuide({ steps: HISTORIS_STEPS, storageKey: HISTORIS_STORAGE_KEY });
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-8">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Storage Bar */}
            <div className="bg-white border border-gray-200 rounded-xl px-5 py-3.5 mb-5 flex items-center gap-4" data-guide="storage-bar">
            ...
            {/* Table */}
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden" data-guide="table-historis">
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((row) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4">
                          <div className="flex items-center justify-center gap-2" data-guide="btn-aksi">
                            <button
                              onClick={() => {
                                const username =
