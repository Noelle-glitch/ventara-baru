        ...
        <div className="p-8">
          <div className="max-w-5xl mx-auto">
            ...
            data-guide="avatar-upload">
              ...
              <div className="ml-63" data-guide="avatar-upload">
                <button
                  onClick={() => fileRef.current?.click()}
            ...
            {/* FORM */}
            <div className="bg-white border border-gray-100 rounded-xl divide-y divide-gray-100 max-w-4xl ml-12" data-guide="form-info">
              {/* Nama */}
